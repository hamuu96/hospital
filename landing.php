		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>Lwe were crowned the most prestige hospital in the medical industry due to our dedication towards our customers and the attention we provide to them.</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					...
					<div class="content">
						<p class="mb-4">St MDX hospital we have the most prestigous Cardiologists</p>
					</div>
				</div>
			</div>
